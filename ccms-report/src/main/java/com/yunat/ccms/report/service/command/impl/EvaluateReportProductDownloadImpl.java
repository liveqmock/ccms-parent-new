...
@Component("evaluateReportProductDownloadImpl")
public class EvaluateReportProductDownloadImpl implements EvaluateReportDownload {

	@Autowired
	@Qualifier("evaluateReportProductComposeImpl")
