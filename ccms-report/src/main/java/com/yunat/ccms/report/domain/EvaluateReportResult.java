 ...
 * 
 * @author yin
 * @see http://media.techtarget.com/tss/static/articles/content/JPA101_Chapter/
 *      JPA101_Chapter.pdf JPA聚合函数出来的结果集是long integer
 * 
 */

@Entity
@Table(name = "evaluate_report_result")
public class EvaluateReportResult implements Serializable {
	...
	public boolean equals(Object object) {
		...
		EvaluateReportResult other = (EvaluateReportResult) object;
