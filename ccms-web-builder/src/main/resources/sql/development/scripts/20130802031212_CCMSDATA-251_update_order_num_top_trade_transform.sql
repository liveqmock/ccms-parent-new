--// CCMSDATA-251_update_order_num_top_trade_transform
-- Migration SQL that makes the change goes here.
alter table top_trade_full_job_buffer  add column num integer DEFAULT NULL COMMENT '商品数量总计';
alter table top_trade_full  add column num integer DEFAULT NULL COMMENT '商品数量总计';
alter table top_trade_incr_job_buffer  add column num integer DEFAULT NULL COMMENT '商品数量总计';
alter table top_trade_incr  add column num integer DEFAULT NULL COMMENT '商品数量总计';
alter table top_trade_job_buffer  add column num integer DEFAULT NULL COMMENT '商品数量总计';
alter table top_trade  add column num integer DEFAULT NULL COMMENT '商品数量总计';
alter table top_jobmid_trade  add column num integer DEFAULT NULL COMMENT '商品数量总计';

alter table plt_taobao_product_skus  MODIFY column outer_id VARCHAR(100) DEFAULT NULL COMMENT '商家设置的外部id';
alter table top_item_sku  MODIFY column outer_id VARCHAR(100) DEFAULT NULL COMMENT '商家设置的外部id';
alter table top_item_sku_job_buffer  MODIFY column outer_id VARCHAR(100) DEFAULT NULL COMMENT '商家设置的外部id';

alter table plt_taobao_refund  MODIFY column num_iid VARCHAR(50) DEFAULT NULL COMMENT '申请退款的商品数字编号';
...
BEGIN
    ...
    insert into top_trade_full
                ...
                has_post_fee,received_payment,cod_fee,cod_status,timeout_action_time,
                payment,discount_fee,point_fee,real_point_fee,shipping_type,
                adjust_fee,buyer_obtain_point_fee,job_execution_id,buyer_memo,seller_memo,seller_flag,num)
    select dp_id,tid,created,modified,endtime,seller_nick,buyer_nick,
           buyer_cod_fee,seller_cod_fee,express_agency_fee,status,
           trade_from,type,alipay_no,pay_time,total_fee,post_fee,
           buyer_alipay_no,receiver_name,receiver_state,receiver_city,
    ...
    insert into top_trade
                ...
                buyer_obtain_point_fee,job_execution_id,buyer_memo,seller_memo,seller_flag,num)
    select dp_id,tid,created,modified,endtime,seller_nick,buyer_nick,
           buyer_cod_fee,seller_cod_fee,express_agency_fee,status,
           trade_from,type,alipay_no,pay_time,total_fee,post_fee,
           buyer_alipay_no,receiver_name,receiver_state,receiver_city,
    ...
    insert into top_trade_incr
                ...
                job_execution_id,buyer_memo,seller_memo,seller_flag,num)
    select dp_id,tid,created,modified,endtime,seller_nick,buyer_nick,
           buyer_cod_fee,seller_cod_fee,express_agency_fee,status,trade_from,
           type,alipay_no,pay_time,total_fee,post_fee,buyer_alipay_no,
           receiver_name,receiver_state,receiver_city,receiver_district,
...
alter table top_trade_full_job_buffer  drop column num;
alter table top_trade_full  drop column num;
alter table top_trade_incr_job_buffer  drop column num;
alter table top_trade_incr  drop column num;
alter table top_trade_job_buffer  drop column num;
alter table top_trade  drop column num;
alter table top_jobmid_trade  drop column num;

alter table plt_taobao_product_skus  MODIFY column outer_id VARCHAR(50) DEFAULT NULL COMMENT '商家设置的外部id';
alter table top_item_sku  MODIFY column outer_id VARCHAR(50) DEFAULT NULL COMMENT '商家设置的外部id';
alter table top_item_sku_job_buffer  MODIFY column outer_id VARCHAR(50) DEFAULT NULL COMMENT '商家设置的外部id';
