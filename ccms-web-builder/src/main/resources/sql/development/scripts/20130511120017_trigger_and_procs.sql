...
-- drop procedures
DROP PROCEDURE  IF EXISTS  proc_dedup_customer ;
DROP PROCEDURE  IF EXISTS  proc_delete_unify_customer ;
DROP PROCEDURE  IF EXISTS  proc_merge_customer ;
DROP PROCEDURE  IF EXISTS  proc_sync_parent_plat ;
DROP PROCEDURE  IF EXISTS  proc_unify_customer ;
DROP PROCEDURE  IF EXISTS  proc_unify_modify_customer ;


-- drop triggers 
DROP  TRIGGER  IF EXISTS  trigger_insert_extaobao_customer ;
DROP  TRIGGER  IF EXISTS  trigger_update_extaobao_customer ;
DROP  TRIGGER  IF EXISTS  trigger_insert_ext_customer ;
DROP  TRIGGER  IF EXISTS  trigger_update_ext_customer ;
DROP  TRIGGER  IF EXISTS  trigger_delete_ext_customer ;
DROP  TRIGGER  IF EXISTS  trigger_insert_kfgzt_customer ;
DROP  TRIGGER  IF EXISTS  trigger_update_kfgzt_customer ;
DROP  TRIGGER  IF EXISTS  trigger_sync_kfgzt_customer ;
DROP  TRIGGER  IF EXISTS  trigger_insert_modify_customer ;
DROP  TRIGGER  IF EXISTS  trigger_update_modify_customer ;
DROP  TRIGGER  IF EXISTS  trigger_insert_wdzx_customer ;
DROP  TRIGGER  IF EXISTS  trigger_update_wdzx_customer ;
DROP  TRIGGER  IF EXISTS  trigger_insert_taobao_customer ;
DROP  TRIGGER  IF EXISTS  trigger_update_taobao_customer ;
