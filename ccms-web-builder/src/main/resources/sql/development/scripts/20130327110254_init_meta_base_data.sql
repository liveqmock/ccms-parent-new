...
INSERT INTO tm_dic_value (dic_value_id, dic_id, parent_id, dic_value, show_name) VALUES (110100, 23, 110000, '北京', '市辖区');
...
INSERT INTO tm_dic_value (dic_value_id, dic_id, parent_id, dic_value, show_name) VALUES (120100, 23, 120000, '天津', '市辖区');
...
INSERT INTO tm_dic_value (dic_value_id, dic_id, parent_id, dic_value, show_name) VALUES (310100, 23, 310000, '上海', '市辖区');
...
INSERT INTO tm_dic_value (dic_value_id, dic_id, parent_id, dic_value, show_name) VALUES (500100, 23, 500000, '重庆', '市辖区');
...
DELETE FROM tm_catalog;
DELETE FROM tm_dic;
DELETE FROM tm_dic_value;
