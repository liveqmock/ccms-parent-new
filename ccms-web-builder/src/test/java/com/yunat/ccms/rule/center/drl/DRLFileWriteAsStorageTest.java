...
public class DRLFileWriteAsStorageTest {

	@Autowired
	private DRLFileWriteAsStorage fileWriter;
	...
	public void testCreateDRLFile() {
		...
		condition21.setPropertyId(500L);
		...
		String fileName = fileWriter.createDRLFile(plan);
