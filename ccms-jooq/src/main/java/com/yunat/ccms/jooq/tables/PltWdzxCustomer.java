...
public class PltWdzxCustomer extends org.jooq.impl.UpdatableTableImpl<org.jooq.Record> {

	private static final long serialVersionUID = 1340565534;

	/**
	 * The singleton instance of ccms.plt_wdzx_customer
	 */
	public static final com.yunat.ccms.jooq.tables.PltWdzxCustomer PLT_WDZX_CUSTOMER = new com.yunat.ccms.jooq.tables.PltWdzxCustomer();
	...
	public PltWdzxCustomer() {
		super("plt_wdzx_customer", com.yunat.ccms.jooq.Ccms.CCMS);
	}

	public PltWdzxCustomer(java.lang.String alias) {
		super(alias, com.yunat.ccms.jooq.Ccms.CCMS, com.yunat.ccms.jooq.tables.PltWdzxCustomer.PLT_WDZX_CUSTOMER);
	}

	@Override
	public org.jooq.UniqueKey<org.jooq.Record> getMainKey() {
		return com.yunat.ccms.jooq.Keys.KEY_PLT_WDZX_CUSTOMER_PRIMARY;
	}

	@Override
	@SuppressWarnings("unchecked")
	public java.util.List<org.jooq.UniqueKey<org.jooq.Record>> getKeys() {
		return java.util.Arrays.<org.jooq.UniqueKey<org.jooq.Record>>asList(com.yunat.ccms.jooq.Keys.KEY_PLT_WDZX_CUSTOMER_PRIMARY);
	}

	@Override
	public com.yunat.ccms.jooq.tables.PltWdzxCustomer as(java.lang.String alias) {
		return new com.yunat.ccms.jooq.tables.PltWdzxCustomer(alias);
	}
}
