...
public class PltExtCustomer extends org.jooq.impl.UpdatableTableImpl<org.jooq.Record> {

	private static final long serialVersionUID = -1342695943;

	/**
	 * The singleton instance of ccms.plt_ext_customer
	 */
	public static final com.yunat.ccms.jooq.tables.PltExtCustomer PLT_EXT_CUSTOMER = new com.yunat.ccms.jooq.tables.PltExtCustomer();
	...
	/**
	 * 外部客户ID。导入非接驳平台客户时无需指定客户ID，因此本字段由统一用户ID生成规则生成，逻辑关联 uni_customer.uni_id
	 * <p>
	...
	public PltExtCustomer() {
		super("plt_ext_customer", com.yunat.ccms.jooq.Ccms.CCMS);
	}

	public PltExtCustomer(java.lang.String alias) {
		super(alias, com.yunat.ccms.jooq.Ccms.CCMS, com.yunat.ccms.jooq.tables.PltExtCustomer.PLT_EXT_CUSTOMER);
	}

	@Override
	public org.jooq.UniqueKey<org.jooq.Record> getMainKey() {
		return com.yunat.ccms.jooq.Keys.KEY_PLT_EXT_CUSTOMER_PRIMARY;
	}

	@Override
	@SuppressWarnings("unchecked")
	public java.util.List<org.jooq.UniqueKey<org.jooq.Record>> getKeys() {
		return java.util.Arrays.<org.jooq.UniqueKey<org.jooq.Record>>asList(com.yunat.ccms.jooq.Keys.KEY_PLT_EXT_CUSTOMER_PRIMARY);
	}

	@Override
	public com.yunat.ccms.jooq.tables.PltExtCustomer as(java.lang.String alias) {
		return new com.yunat.ccms.jooq.tables.PltExtCustomer(alias);
	}
}
