...
public class PltModifyCustomer extends org.jooq.impl.UpdatableTableImpl<org.jooq.Record> {

	private static final long serialVersionUID = 1388955703;

	/**
	 * The singleton instance of ccms.plt_modify_customer
	 */
	public static final com.yunat.ccms.jooq.tables.PltModifyCustomer PLT_MODIFY_CUSTOMER = new com.yunat.ccms.jooq.tables.PltModifyCustomer();
	...
	/**
	 * 客户ID, 手工修改的客户ID值与其uni_customer.uni_id一致, 有外键关联
	 * <p>
	...
	public PltModifyCustomer() {
		super("plt_modify_customer", com.yunat.ccms.jooq.Ccms.CCMS);
	}

	public PltModifyCustomer(java.lang.String alias) {
		super(alias, com.yunat.ccms.jooq.Ccms.CCMS, com.yunat.ccms.jooq.tables.PltModifyCustomer.PLT_MODIFY_CUSTOMER);
	}

	@Override
	public org.jooq.UniqueKey<org.jooq.Record> getMainKey() {
		return com.yunat.ccms.jooq.Keys.KEY_PLT_MODIFY_CUSTOMER_PRIMARY;
	}

	@Override
	@SuppressWarnings("unchecked")
	public java.util.List<org.jooq.UniqueKey<org.jooq.Record>> getKeys() {
		return java.util.Arrays.<org.jooq.UniqueKey<org.jooq.Record>>asList(com.yunat.ccms.jooq.Keys.KEY_PLT_MODIFY_CUSTOMER_PRIMARY);
	}

	@Override
	public com.yunat.ccms.jooq.tables.PltModifyCustomer as(java.lang.String alias) {
		return new com.yunat.ccms.jooq.tables.PltModifyCustomer(alias);
	}
}
