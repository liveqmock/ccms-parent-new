...
public class PltExtaobaoCustomer extends org.jooq.impl.UpdatableTableImpl<org.jooq.Record> {

	private static final long serialVersionUID = 1809582829;

	/**
	 * The singleton instance of ccms.plt_extaobao_customer
	 */
	public static final com.yunat.ccms.jooq.tables.PltExtaobaoCustomer PLT_EXTAOBAO_CUSTOMER = new com.yunat.ccms.jooq.tables.PltExtaobaoCustomer();
	...
	public PltExtaobaoCustomer() {
		super("plt_extaobao_customer", com.yunat.ccms.jooq.Ccms.CCMS);
	}

	public PltExtaobaoCustomer(java.lang.String alias) {
		super(alias, com.yunat.ccms.jooq.Ccms.CCMS, com.yunat.ccms.jooq.tables.PltExtaobaoCustomer.PLT_EXTAOBAO_CUSTOMER);
	}

	@Override
	public org.jooq.UniqueKey<org.jooq.Record> getMainKey() {
		return com.yunat.ccms.jooq.Keys.KEY_PLT_EXTAOBAO_CUSTOMER_PRIMARY;
	}

	@Override
	@SuppressWarnings("unchecked")
	public java.util.List<org.jooq.UniqueKey<org.jooq.Record>> getKeys() {
		return java.util.Arrays.<org.jooq.UniqueKey<org.jooq.Record>>asList(com.yunat.ccms.jooq.Keys.KEY_PLT_EXTAOBAO_CUSTOMER_PRIMARY);
	}

	@Override
	public com.yunat.ccms.jooq.tables.PltExtaobaoCustomer as(java.lang.String alias) {
		return new com.yunat.ccms.jooq.tables.PltExtaobaoCustomer(alias);
	}
}
