...
public class HelloWordDroolsTester {
	...
	private static void initDrools() {
		...
		// read from file
		kbuilder.add(ResourceFactory.newClassPathResource("/drools/testrules.drl", HelloWordDroolsTester.class),
				ResourceType.DRL);

		// read second rule from String
		String myRule = "import com.yunat.ccms.personalized.packaging.Message rule \"Hello World 2\" when message:Message (type==\"Test\") then System.out.println(\"Test, Drools!\"); end";
